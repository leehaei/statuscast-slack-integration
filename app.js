...
function sendSuccess(id, date, title, components, in_message, type_val) {
	...
	var bot_message = "[{\"mrkdwn_in\":[\"text\"],\"color\":\"" + color +"\",\"pretext\":\"You have created a new *" + type_val + "* incident *ID: " + id + "* from Slack:\",\"title\": \"See Details\",\"title_link\": \"https://igm-devops.slack.com/archives/CURG4CVHS\",\"actions\": [{\"name\": \"game\",\"text\": \"Delete\",\"style\": \"danger\",\"type\": \"button\",\"value\": \"war\",\"confirm\": {\"title\": \"Delete Incident\",\"text\": \"Are you sure?\",\"ok_text\": \"Yes\",\"dismiss_text\": \"No\"}}]}]";
	const args1 = {
		channel: bot_ID,
